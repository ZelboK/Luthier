...
// LLVM 23 stopped transitively including MachineFrameInfo through
// MachineFunction.h; we touch FrameInfo.hasStackObjects() / getStackSize()
// below, so include it directly.
